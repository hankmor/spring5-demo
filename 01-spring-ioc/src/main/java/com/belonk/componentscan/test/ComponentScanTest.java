package com.belonk.componentscan.test;

import com.belonk.componentscan.bean.User;
import com.belonk.componentscan.config.BasicComponentScanConfig;
import com.belonk.componentscan.config.ComponentScanFilterConfig;
import com.belonk.componentscan.config.ComponentScanLazyConfig;
import com.belonk.componentscan.config.CustomFilterConfig;
import com.belonk.componentscan.controller.UserController;
import com.belonk.componentscan.config.MultiComponentScanConfig;
...
public class ComponentScanTest {
    ...
    public void testComponentScanFilter() {
        ...
        Printer.printBeans(applicationContext);
		/*~:
		bean count: 7
